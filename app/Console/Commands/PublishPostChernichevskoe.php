...
class PublishPostChernichevskoe extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:publish-post-chernichevskoe';
     ...
     * @var string
     */
    protected $description = 'Команда публикует прогноз по Чернышевское - Kybartai в канал';
    ...
    {
        // Чернышевское - Kybartai
        $result = $this->reportService->getStatistics(3);

        $formatedText = "На текущий момент прогноз прохождения пограничного перехода *Чернышевское \\- Kybartai* составляет:";
