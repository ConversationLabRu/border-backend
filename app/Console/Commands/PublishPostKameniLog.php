...
class PublishPostKameniLog extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:publish-post-kameni-log';
     ...
     * @var string
     */
    protected $description = 'Команда публикует прогноз по Каменный Лог - Medininkai в канал';
    ...
    public function handle()
    {
        ...
        $result = $this->reportService->getStatistics(5);

        $formatedText = "На текущий момент прогноз прохождения пограничного перехода *Каменный Лог \\- Medininkai* составляет:";
