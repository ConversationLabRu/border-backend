...
class PublishPostBagrat extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:publish-post-bagrat';
     ...
     * @var string
     */
    protected $description = 'Команда публикует прогноз по Багратионовск - Bezledy в канал';
    ...
    {
        // Багратионовск - Bezledy
        $result = $this->reportService->getStatistics(8);

        $formatedText = "На текущий момент прогноз прохождения пограничного перехода *Багратионовск \\- Bezledy* составляет:";
